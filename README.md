...
🏆 Как играть
Создайте комнату на главной странице
Пригласите друзей (поделитесь room ID)
Добавьте ботов (опционально) для заполнения мест
Начните игру (только хост)
Нажимайте кнопки:
